        ...
        {products?.similar?.map((product: any) => {
          ...
          return (
            <div key={product.id} className="relative h-full w-full">
              <div
                className="border h-full border-gray-200 bg-white rounded-lg flex flex-col justify-between cursor-pointer p-5 "
              >
                <div
                ...
                <button
                  className="bg-green-600 text-white text-xs md:text-sm my-2  rounded-full w-4/5 sm:w-3/5 mx-auto  p-2 relative bottom-0"
                >
                  Add to cart
                </button>
                <div
