...
router.push(`/product/${slug}`)
  ...
  return (
   <>{ products?.alternatives?.length>0 &&
    <div className="flex flex-col text-black mt-7 w-[90%] lg:w-[85%] 2xl:w-[75%] mx-auto ">
    <h1 className="text-lg md:text-xl  font-extrabold my-2" style={{color:'#29a637'}}>
Alternative
    </h1>
    ...
    {products?.alternatives?.map((product: any) => {
            ...
            return (
              ...
              <button
               style={{backgroundColor:'#29a637'}} className=" text-white text-xs md:text-sm  rounded-full w-4/5 sm:w-3/5 mx-auto my-2 p-2 relative bottom-0"
              >
                Add to cart
              </button>
              <div>
